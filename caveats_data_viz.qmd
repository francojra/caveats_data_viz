...
A poucas semanas atrás, eu li um tweet que dizia "não compare a mudança de porcentagem em uma escala linear, use uma escala log ao invés disso. -50% (0,5×) é uma mudança tão grande quanto +100% (2×)." Ele inseriu dois mapas com os mesmos dados, mas um deles estava em escala linear (primeiro gráfico) enquanto o outro estava em escala logarítmica (segundo gráfico).
