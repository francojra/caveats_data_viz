...
Considere se existe uma alternativa melhor às cores de gradiente ao codificar os valores mais importantes. Cores de gradiente podem ser ótimas para mostrar um padrão, mas ela dificulta decifrar valores reais na diferença entre as categorias de grupos. Assim, considere mostrar seus mais importantes valores com barras, gráficos de ponto (dotplot) ou mesmo áreas, e use cores apenas para mostrar diferenças entre categorias, isso confunde menos os leitores que poderão decifrar os valores mais rápido.
